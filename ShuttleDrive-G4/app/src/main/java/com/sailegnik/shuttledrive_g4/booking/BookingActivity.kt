...
import com.sailegnik.shuttledrive_g4.payment.PaymentActivity

class BookingActivity : AppCompatActivity() {
    private lateinit var binding: ActivityBookingBinding
    private lateinit var shuttleImg: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shuttleImg = findViewById(R.id.shuttleImg)
        ...
        //using intent data
        shuttleImg.setImageResource(i_shuttleImg)
        name.text = i_name
        from.text = i_from
        to.text = i_to
        date.text = i_date
